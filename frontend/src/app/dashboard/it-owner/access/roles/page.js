...
const ROLES = [
  ...
  },
  {
    ...
    badge: '#6b7280',
    icon: <User size={20} />,
    summary: 'Self-service access for day-to-day work, attendance, leave, and payroll visibility.',
    can: [
      'Clock in and clock out with face verification',
      'Apply for leave and track request status',
      'View attendance history and monthly active hours',
      'Download their own payroll slips from the payroll portal',
      'Update personal profile and emergency contacts',
      'View company announcements, policies, and notifications',
    ],
    cannot: [
